...
function WeddingLinkFront({ FrontData }) {
  ...
  return (
    <>
      <div
        className={`${style.cover} w-full max-w-[90vw] h-full max-h-[90vh] min-h-[250px] min-w-[250px] object-contain bg-cover absolute mx-auto`}
        style={{
    ...
    style={{ fontFamily:FrontData.FrontFont  }}
  >
  <h1
        className="text-center"
        style={{
          color: FrontData.Color,
          fontSize: `${FrontData.FontSize}rem`, // Use rem instead of vh
        }}
      >
        {FrontData.Name}
      </h1>
