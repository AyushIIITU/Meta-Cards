        ...
        <div className={style["flip-card"]}>
          <div className={style["flip-card-inner"]}>
            <div className={style["flip-card-front"]}>
              <div className="velas" style={{ top: "33vh" }}>
            ...
            <div className={style["flip-card-back"]}>
              ...
              <p>May your special day be filled with joy and laughter. As you celebrate another year of life, may you cherish the memories and embrace the future. May your wishes come true, and may this year be your best yet. Happy birthday!</p>
            </div>
          </div>
        </div>
      </div>
